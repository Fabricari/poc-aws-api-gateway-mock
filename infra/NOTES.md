...
[README.md Preview]
Alright, so, here we go. Even though this is just a proof-of-concept, I still had to make a couple small decisions. For one, I'm using a Mac, so I decided to use VSCode. It gets the job done, and I figured it'd be good see how it handles proper .NET solutions. And for that matter, I decided to use the latest version of the framework. .NET 10 just dropped, and it's got that Long-Term Support. And I've been wanting to get more familiar with some of that new syntactic sugar anyway. I think, for the most part, what you're gonna see here is pretty simple and self-documenting, regardless of what ever language you prefer to use. That said, just remember, this is all throw-away code. You can go ahead and download it, but you definitely don't want to use it for production.
